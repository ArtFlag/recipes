...
|---------------|----------------------------------------------------------------|-----------------------------|
| Flour         | 100%                                                           | {i.flour}g                  |
| Water         | <Percent reference={i.flour} value={i.water} showSign/>        | {i.water}g                  |
| Baking powder | <Percent reference={i.flour} value={i.bakingPowder} showSign/> | {i.bakingPowder}g           |
| Sel           | <Percent reference={i.flour} value={i.salt} showSign/>         | {i.salt}g                   |
| Shortening    | <Percent reference={i.flour} value={i.shortening} showSign/>   | {i.shortening}g             |
